    ...
    function btnClick()
     ...
     if (document.getElementById('InputName').value==""){
	    ...
	    return alert("Спасибо!");
					...
					<form name="lidmagnit" id="2" method="post" action="<?php echo e(asset('/lidmagnit')); ?>" enctype="multipart/form-data">	
					<?php echo csrf_field(); ?>

						<div class="form-group">
							<label for="name">Ваше имя:</label>
							<div id='err_name' class='error'></div>
							<input type="name" name="name" class="form-control" id="InputName"  placeholder="Введите имя">
						...
						<div class="form-group form-check">
						   <label class="form-check-label">
							<input type="checkbox" class="form-check-input" checked> Я выражаю согласие на обработку персональных данных согласно <a href="<?php echo e(asset('confedencialnost')); ?>">политике конфиденциальности</a>
						  </label>
					    </div>
						<hr>
						<button type="submit" class="btn btn-primary btn-lg center-block" onClick="btnClick();">Получить подарок</button>

					<!--<form name="Lidmagnit_form" id="Lidmagnit_form" action="<?php echo e(asset('/lidmagnit')); ?>" method="post" onsubmit="return validate(this);">
						<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\site\resources\views/lidmagnit.blade.php ENDPATH**/ ?>