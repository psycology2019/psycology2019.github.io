...
<html lang="ru">
 <head>
  ...
  <script type="text/javascript" src="<?php echo e('media/js/index.js'); ?>"></script>
  <script type="text/javascript" src="<?php echo e('media/js/button_up.js'); ?>"></script>
  <script type="text/javascript" src="<?php echo e('media/js/lidform.js'); ?>"></script>
  <?php echo $__env->yieldSection(); ?>   
 </head>
 <body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="">
                        <a class="page-scroll" href="<?php echo e(asset('/')); ?>">Главная</a>
                    </li>
                    <li class="">
                        <a class="page-scroll" href="<?php echo e(asset('about')); ?>">Обо мне</a>
                    </li>
                    <li class="">
                        <a class="page-scroll" href="<?php echo e(asset('consultation')); ?>">Консультации</a>
                    </li>
                    <li class="">
                        <a class="page-scroll" href="<?php echo e(asset('program')); ?>">Программы</a>
                    </li>					
					<li class="">
                        <a class="page-scroll" href="<?php echo e(asset('revies')); ?>">Отзывы</a>
                    </li>
					<li class="">
                        <a class="page-scroll" href="<?php echo e(asset('contact')); ?>">Контакты</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
	 ...
	 <div class="container block_indent">
		<div class="row">
			<div class="col-md-5 footer_info">
				<a href="<?php echo e(asset('oferta')); ?>">Договор оферта</a>
				<a href="<?php echo e(asset('confedencialnost')); ?>">Политика конфиденциальности сайта molodyanova.com</a>
				<a href="<?php echo e(asset('oferta')); ?>">Способы оплаты</a>
				<div class="pay_system">
                
				<a href="<?php echo e(url('https://bepaid.by')); ?>"><img src="media/img/pay_system/bePaid(681).png" alt="bepaid" title="bepaid"></a>
...
</html><?php /**PATH C:\OSPanel\domains\site\resources\views/layouts/base.blade.php ENDPATH**/ ?>