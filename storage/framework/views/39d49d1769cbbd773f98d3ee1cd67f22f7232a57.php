    ...
    <section style="background-color: #efefef;" class='program_release' >
      <div class="row" >
		...
		<div class="col-md-6 realese_bl_txt" >
		  ...
		  <p>Читайте отзывы о программе в разделе <a class="page-scroll" href="<?php echo e(asset('revies')); ?>">ОТЗЫВЫ</a>.</p>
		</div>
	 </div>		
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\site\resources\views/program_release.blade.php ENDPATH**/ ?>